  ...
  return (
    <section id="home" className="relative">
          ...
          <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-12 md:items-end">
            ...
            <div className="flex flex-col gap-5 md:items-start">
              <motion.p
                ...
                animate="show"
                custom={0.2}
                className="text-cream/80 text-sm md:text-base leading-relaxed max-w-md"
              >
                {profile.heroSubcopy}
              </motion.p>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                href="#projects"
                className="inline-flex items-center gap-2 self-start bg-accent text-bg font-semibold text-sm px-6 py-3.5 rounded-full"
              >
                See my works
      ...
      <motion.h2
        ...
        className="font-display font-black uppercase text-cream text-center leading-none py-8 md:py-12 px-4"
        style={{ fontSize: 'clamp(56px, 15vw, 180px)', letterSpacing: '-0.01em' }}
      >
        {profile.name}
      </motion.h2>
    </section>
